...
- (void)setupUI {
    ...
    self.goodsPic.frame=CGRectMake(Gap *2, Gap, Gap * 2 , Gap * 2);
    self.goodsPic.image=[UIImage imageNamed:@"Logistics_i"];
    ...
    UILabel *line=[[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.phoneLabel.frame)+Gap, DWQScreenWidth, Gap)];
