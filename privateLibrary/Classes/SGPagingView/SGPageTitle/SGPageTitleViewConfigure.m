...
- (UIColor *)titleColor {
    if (!_titleColor) {
        _titleColor = [UIColor colorWithRed:(51.0f/255) green:(51.0f/255) blue:(51.0f/255) alpha:1.0f];
    }
    return _titleColor;
}
...
- (UIColor *)titleSelectedColor {
    if (!_titleSelectedColor) {
        _titleSelectedColor = [UIColor colorWithRed:(51.0f/255) green:(51.0f/255) blue:(51.0f/255) alpha:1.0f];
    }
...
- (UIColor *)indicatorColor {
    if (!_indicatorColor) {
        ...
        _indicatorColor = [UIColor colorWithRed:(237/255.0f) green:(41/255.0f) blue:(118/255.0f) alpha:1.0f];
    }
